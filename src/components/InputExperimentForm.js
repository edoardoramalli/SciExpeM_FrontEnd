...
import {MinusCircleOutlined, UploadOutlined, PlusCircleOutlined} from "@ant-design/icons";
...
class CommonPropertiesForm extends React.Component {
    ...
    handleExperimentsOk = () => {
        ...
        render()
        {
            ...
            const ignition_definition_type =
                <FormItem
            ...
            const ignition_definition_quantity =
                <FormItem
                    label={"Ignition definition measured quantity"}
                    name={'ignition_definition_quantity'}>
            ...
            const experimentTypeSelect = <FormItem
                ...
                <div>
                    ...
                    <Form layout={"horizontal"} onFinish={onFinish}>
                        <Collapse defaultActiveKey={['1', '3', '4', '5', '6', '7', '8']}>
                            ...
                            {/*            <PlusCircleOutlined /> Add species*/}
                            {/*        </Button>*/}
                            {/*    </FormItem>*/}
                            {/*</Panel>*/}
    ...
    const
    WrappedCommonPropertiesForm = CommonPropertiesForm;
    export
    default
    WrappedCommonPropertiesForm