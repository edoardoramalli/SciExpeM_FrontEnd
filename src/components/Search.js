...
class CMBars extends React.Component {
    ...
    render() {
      ...
      componentDidMount() {
        axios.get(window.$API_address + 'frontend/api/curve_matching_global_results_dict', {
            params: {
...
class SearchPanelRaw
    ...
    componentDidMount() {
        axios.get(window.$API_address + 'frontend/api/experiments/searchfields')
            .then(res => {
...
class ModelTable extends React.Component {
    ...
    componentDidMount() {
        ...
        axios.get(window.$API_address + 'frontend/api/models/')
            .then(res => {
...
class OutputMenu extends React.Component {
    ...
    downloadResume = (action) => {
       axios.get(window.$API_address + 'frontend/api/curve_matching_global_results/download', {
            params: {
...
class SearchAndExecute extends React.Component {
    ...
    retrieveExperiments(searchValues) {
        this.setState({loading: true});
        axios.get(window.$API_address + 'frontend/api/experiments/search', {
            params: {
...
class ExperimentExecutionsDraw extends React.Component {
    ...
    componentDidMount() {
        ...
        axios.get(window.$API_address + 'frontend/api/opensmoke/curves', {
            params: {
...
class CurveMatchingTable extends React.Component {
    ...
    componentDidMount() {
        axios.get(window.$API_address + 'frontend/api/curve_matching_global_results', {
            params: {
                experiments: this.props.experiments,
                chemModels: this.props.chemModels,
...
class CurveMatchingTableOld extends React.Component {
    ...
    componentDidMount() {
        ...
        axios.get(window.$API_address + 'frontend/api/curve_matching_results',  {
            params: {
                experiment: this.props.experiment,
                chemModels: this.props.chemModels
            }
...
class CurveMatchingResult extends React.Component {
    ...
    handleClick = (e) => {
        ...
        if (e.key === 'input') {
            ...
            const request_url = window.$API_address + 'frontend/api/opensmoke/download/output';
            axios.get(request_url, {
                responseType: 'blob',
                timeout: 30000,
                params: {
