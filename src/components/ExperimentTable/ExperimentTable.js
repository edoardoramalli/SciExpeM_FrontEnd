    ...
    onFinish = values => {
        ...
        const params = {
            ...
            query: {
                ...
                'fileDOI__icontains': values.fileDOI !== '' ? values.fileDOI : undefined,
            },
                                ...
                                <Space size={'large'}>
                                    ...
                                    <Col>
                                        <Form.Item
                                            ...
                                            rules={[{required: false}]}
                                        >
                                            <Select placeholder={'Please select a reactor'} allowClear
                                                    style={{width: 200}}>
                                ...
                                <Space size={'large'}>
                                    ...
                                    <Col>
                                        ...
                                        >
                                            ...
                                            <Input placeholder="Insert experiment DOI" allowClear style={{width: 320}}/>
                                        </Form.Item>
                                    </Col>
